...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <div class="form-group">
            <asp:Label ID="lbl2" runat="server" Text="Datos Medico"></asp:Label>

            <asp:TextBox ID="TbxEspecialidad" placeholder="Especialidad" runat="server"></asp:TextBox>
            <asp:TextBox ID="txtMatricula" placeholder="Matricula" runat="server"></asp:TextBox>
